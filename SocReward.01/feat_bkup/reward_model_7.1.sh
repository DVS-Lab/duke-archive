...
MAINOUTPUT=${MAINDIR}/${SUBJ}_Model7.1_${SMOOTH}mm_ST_v${AUTOVERSION}
...
FSLEVDIR=${EXPERIMENT}/Analysis/FSL/EV_Logs_3-10-08_new/Model_7.1/${SUBJ}/Passive
...
for i in 'reward_model_7_template.fsf'; do
