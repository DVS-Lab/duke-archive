		...
		for AUTOVERSION in "0.7.1"; do
			...
			for OPTION in "crap_removed"; do
				...
				#for SUBJ in 33746; do
					...
					qsub -v EXPERIMENT=SocReward.01 reward_model_7.2.sh ${SUBJ} ${RUN} ${SMOOTH} ${AUTOVERSION} ${OPTION}
					qsub -v EXPERIMENT=SocReward.01 reward_model_7.2_NoMotor.sh ${SUBJ} ${RUN} ${SMOOTH} ${AUTOVERSION} ${OPTION}
