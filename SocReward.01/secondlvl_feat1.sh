...
if [ $TD == "yes" ]; then
	...
	if [ $MOTOR == "yes" ]; then
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model8_${OPTION}_${SMOOTH}mm_ST_TD
	else
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model8_${OPTION}_NoMotor_${SMOOTH}mm_ST_TD
	fi
	...
	if [ $MOTOR == "yes" ]; then
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model8_${OPTION}_${SMOOTH}mm_ST
	else
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model8_${OPTION}_NoMotor_${SMOOTH}mm_ST
	fi
...
if [ $SUBJ -eq 33732 ]; then
	...
	TEMPLATE=level2_template33732_model8.fsf
	cd $TEMPLATEDIR
	...
	TEMPLATE=level2_template_model8.fsf
	cd $TEMPLATEDIR
	for i in $TEMPLATE; do
	sed -e 's@OUTPUT@'$OUTPUT'@g' \
	    -e 's@INPUT1@'$INPUT1'@g' \
