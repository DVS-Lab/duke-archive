	...
	for RUN in 2 3 4 5 6; do
		...
		for SMOOTH in "6"; do
			...
			for LIST in "air.hdr air"; do
				...
				REF=${FUNCDIR}/${SUBJ}_run${RUN}.ica/example_func.nii.gz
				DATA=${FUNCDIR}/${SUBJ}_run${RUN}.ica/filtered_func_data.nii.gz
				MATRIX=${FUNCDIR}/${SUBJ}_run${RUN}.ica/reg/standard2example_func.mat
				INPUT=${MASK}
