...
if [ $SCALEDONLY == "no" ]; then
	...
	if [ $NEG == "yes" ]; then
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model11_neg_scaled_${OPTION}_NoMotor_6mm_ST
	else
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model11_scaled_${OPTION}_NoMotor_6mm_ST
	fi
	...
	if [ $NEG == "yes" ]; then
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model11_neg_scaledonly_${OPTION}_NoMotor_6mm_ST
	else
		MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model11_scaledonly_${OPTION}_NoMotor_6mm_ST
	fi
