...
template_f = file("linear_increase.sh")  #job template location (on head node)
			...
			for model in models:
				for subnum in subnums:
					...
					for run in runs:
						...
						tmp_job_file = tmp_job_file.replace( "SUB_RUN_VAR", str(run) )
						...
						tmp_job_fname = "_".join( ["PPI", condition, subnum, run, go] )
