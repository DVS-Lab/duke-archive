...
MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_LinearDecrease_${OPTION}_6mm_ST
...
if [ $SUBJ -eq 33732 ]; then
	...
	TEMPLATE=level2_template33732_model10+11.fsf
	cd $TEMPLATEDIR
...
# 
# elif [ $SUBJ -eq 32976 ] && [ "$OPTION" == "money" ]; then
# 
# 	INPUT1=${MAINDIR2}/${SUBJ}_${OPTION}_4.feat
# 	INPUT2=${MAINDIR2}/${SUBJ}_${OPTION}_3.feat
# 	INPUT4=${MAINDIR2}/${SUBJ}_${OPTION}_5.feat
# 	INPUT5=${MAINDIR2}/${SUBJ}_${OPTION}_6.feat
# 	
# 	TEMPLATE=level2_template33732_model9_${OPTION}.fsf
# 	cd $TEMPLATEDIR
# 	for i in $TEMPLATE; do
# 	sed -e 's@OUTPUT@'$OUTPUT'@g' \
# 	    -e 's@INPUT1@'$INPUT1'@g' \
