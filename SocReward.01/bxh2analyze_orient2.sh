...
rm -rf ${SUBJ}_reoriented_anat.data

bxhreorient --orientation LAS series*.bxh ${SUBJ}_reoriented_anat.bxh

bxh2analyze -s -b --nii ${SUBJ}_reoriented_anat.bxh $NEWANATDIR/${SUBJ}_anat
...
RUN=$RUN2
	...
	rm -rf reoriented_run${RUN2}.bxh
	rm -rf reoriented_run${RUN2}.data
