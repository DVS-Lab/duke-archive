...
MAINOUTPUT=${MAINDIR}/3rd_level_copes/3rd_level_MODEL4-TD_denoised_averse_fixed
ANALYZED=${MAINOUTPUT}
...
INPUT01=${MAINDIR}/32918_2nd_lvl_model4_td_denoised.gfeat/cope${RUN}.feat/stats/cope1.nii.gz
...
INPUT09=${MAINDIR}/33064_2nd_lvl_model4_td_denoised.gfeat/cope${RUN}.feat/stats/cope1.nii.gz
...
INPUT12=${MAINDIR}/33288_2nd_lvl_model4_td_denoised.gfeat/cope${RUN}.feat/stats/cope1.nii.gz
...
INPUT23=${MAINDIR}/33784_2nd_lvl_model4_td_denoised.gfeat/cope${RUN}.feat/stats/cope1.nii.gz
 ...
 echo $OUTPUT
 for i in 'model4+averse_3rd_fixed.fsf'; do
   ...
   -e 's@INPUT23@'$INPUT23'@g' <$i> ${ANALYZED}/3rdLvlFixed_${RUN}_${CON_NAME}.fsf
 done
