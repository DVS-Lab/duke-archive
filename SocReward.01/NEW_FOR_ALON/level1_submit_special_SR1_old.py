...
template_f = file("full_analysis_SR1.sh")  #job template location (on head node)
...
max_run_time = 90           #maximum time any job is allowed to run in minutes
...
subnums = ["32953"]
#OPTIONS = ["PERM4", "OPTION_5", "OPTION_10", "OPTION_20"]
OPTIONS = ["PERM4"]

AR1S = ["1"]
#OPTIONS = ["PERM1", "PERM2", "PERM3", "PERM4"]
#OPTIONS = ["1", "2", "3", "4"]
SMOOTHS = ["0"]
RUNS = ["2", "3", "4", "5", "6"]
GOES = ["1"]
	...
	for SMOOTH in SMOOTHS:
		for subnum in subnums:
			...
			for RUN in RUNS:
				...
				tmp_job_fname = "_".join( ["L1", subnum, RUN, GO, SMOOTH] )
