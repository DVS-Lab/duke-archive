...
if [ $AR1 -eq 1 ]; then
	TEMPLATE=SocReward01_stats.fsf
	MAINOUTPUT=${SUBJDIR}/${SUBJ}_FullAnalysis_${SMOOTH}mm_Smooth_AR1
else
	TEMPLATE=SocReward01_stats_noAR1.fsf
	MAINOUTPUT=${SUBJDIR}/${SUBJ}_FullAnalysis_${SMOOTH}mm_Smooth_noAR1
fi
