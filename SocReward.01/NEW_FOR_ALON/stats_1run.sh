...
#MAINOUTPUT=${SUBJDIR}/NEW_ANALYSES/${SUBJ}_FEAT_native_${SMOOTH}mm_PERM${PERM}
...
#DATA=${MAINDIR}/NEWDATA/smooth6mm/permutation${PERM}/native/${SUBJ}/data_run${RUN}.nii.gz
...
for i in socreward01_stats.fsf; do
