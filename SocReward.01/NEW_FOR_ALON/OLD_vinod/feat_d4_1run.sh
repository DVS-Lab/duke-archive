...
SUBJDIR=${MAINDIR}/Design4/Smooth_${SMOOTH}mm/${SUBJ}_feat
...
CONFOUND_EV_02=${MAINDIR}/EV_files/EVs_normed2/RW_${SUBJ}/run${RUN}/${SUBJ}_Run${RUN}_air_118.txt

cd ${TEMPLATEDIR}
for i in stats_new_3regs.fsf; do
