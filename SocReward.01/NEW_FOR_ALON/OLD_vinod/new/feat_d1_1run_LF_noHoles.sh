...
SUBJDIR=${MAINDIR}/FINAL_RESULTS/Smooth_${SMOOTH}mm/${SUBJ}_feat_LF_NoHoles
...
#F:\Finance.01\Analysis\forAlon\NEWDATA_cluster_NoHoles
DATA=${MAINDIR2}/forAlon/NEWDATA_cluster_NoHoles/${SUBJ}/data_run${RUN}.nii.gz
...
cd ${TEMPLATEDIR}
for i in stats_new_1regs.fsf; do
