...
SUBJDIR=${MAINDIR}/Design9/Smooth_${SMOOTH}mm/${SUBJ}_feat/run${RUN}
...
CONFOUND_EV_03=${MAINDIR}/EV_files/EVs_normed2/RW_${SUBJ}/run${RUN}/${SUBJ}_Run${RUN}_air_118.txt

cd ${TEMPLATEDIR}
for i in stats_new_4regs+ROI.fsf; do
 sed -e 's@OUTPUT@'$OUTPUT'@g' \
     -e 's@TASK@'$TASK'@g' \
     -e 's@CONFOUND_EV_01@'$CONFOUND_EV_01'@g' \
     -e 's@CONFOUND_EV_02@'$CONFOUND_EV_02'@g' \
     -e 's@CONFOUND_EV_03@'$CONFOUND_EV_03'@g' \
     -e 's@ANAT@'$ANAT'@g' \
