...
for MODEL in "faces" "money"; do
	...
	if [ "$MODEL" == "faces" ]; then
		...
		for LIST in "all 1" "gain5 2" "gain2 3" "gain1 4" "loss5 5" "loss2 6" "loss1 7" "gain-loss 8" "loss-gain 9" "5gain-5loss 10" "5loss-5gain 11" "5+2gain-5+2loss 12" "5+2loss-5+2gain 13" "5-1 14" "5-2 15" "5_2-1 16" "5-1_2 17"; do
