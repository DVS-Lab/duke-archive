...
MAINOUTPUT=${MAINDIR}/L3_NEW_cons_lin_all_COV
mkdir -p $MAINOUTPUT
...
# 	FILE_CHECK=${MAINDIR}/${SUBJ}/${SUBJ}_Model9_${OPTION}_6mm_ST/${SUBJ}_2ndlevel_${OPTION}.gfeat/cope${COPE_NUM}.feat/stats/cope1.nii.gz
	...
	eval INPUT${NN}=${MAINDIR}/${SUBJ}/${SUBJ}_Positive_Linear_all/${SUBJ}_2ndlevel.gfeat/cope${COPE_NUM}.feat/stats/cope1.nii.gz
	FILE_CHECK=${MAINDIR}/${SUBJ}/${SUBJ}_Positive_Linear_all/${SUBJ}_2ndlevel.gfeat/cope${COPE_NUM}.feat/stats/cope1.nii.gz
