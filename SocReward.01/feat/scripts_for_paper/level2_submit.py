...
template_f = file("L2_linear.sh")  #job template location (on head node)
...
max_run_time = 600           #maximum time any job is allowed to run in minutes
...
for GO in GOES:
	...
	for OPTION in OPTIONS:
		...
		for subnum in subnums:
			...
			tmp_job_fname = "_".join( ["L2", subnum, OPTION, GO] )
