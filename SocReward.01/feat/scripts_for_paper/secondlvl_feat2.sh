...
MAINDIR2=${MAINDIR}/${SUBJ}/${SUBJ}_Model9_${OPTION}_6mm_ST
...
if [ $SUBJ -eq 33732 ]; then
	...
	TEMPLATE=level2_template33732_model9_${OPTION}_new.fsf
	cd $TEMPLATEDIR
	...
	TEMPLATE=level2_template_model9_${OPTION}_new.fsf
	cd $TEMPLATEDIR
	for i in $TEMPLATE; do
	sed -e 's@OUTPUT@'$OUTPUT'@g' \
	    -e 's@INPUT1@'$INPUT1'@g' \
