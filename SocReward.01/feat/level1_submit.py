...
template_f = file("new_stats.sh")  #job template location (on head node)
experiment = "Finance.01"    #experiment name for qsub
		...
		for subnum in subnums:
			...
			for OPTION in OPTIONS:
				for RUN in RUNS:
					...
					tmp_job_fname = "_".join( ["L1", subnum, OPTION, RUN, GO] )
