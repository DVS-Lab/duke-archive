...
if [ $SCALEDONLY == "no" ]; then
	...
	if [ $NEG == "yes" ]; then
		...
		MAINOUTPUT=${MAINDIR}/${SUBJ}_Model10_neg_scaled_money_NoMotor_6mm_ST
	
	else
	
		FSLEVDIR=${EXPERIMENT}/Analysis/FSL/EV_Logs_3-29-08/Model_10_scaled/${SUBJ}/Passive
		MAINOUTPUT=${MAINDIR}/${SUBJ}_Model10_scaled_money_NoMotor_6mm_ST
	...
	if [ $NEG == "yes" ]; then
		...
		FSLEVDIR=${EXPERIMENT}/Analysis/FSL/EV_Logs_3-29-08/Model_10_neg_scaled/${SUBJ}/Passive
		MAINOUTPUT=${MAINDIR}/${SUBJ}_Model10_neg_scaledonly_money_NoMotor_6mm_ST
	
	else
	
		FSLEVDIR=${EXPERIMENT}/Analysis/FSL/EV_Logs_3-29-08/Model_10_scaled/${SUBJ}/Passive
		MAINOUTPUT=${MAINDIR}/${SUBJ}_Model10_scaledonly_money_NoMotor_6mm_ST
