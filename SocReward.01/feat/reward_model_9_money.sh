...
if [ "$TD" == "yes" ]; then
	...
	MAINOUTPUT=${MAINDIR}/${SUBJ}_Model9_money_${SMOOTH}mm_ST_TD
	TEMPLATE=reward_model_9_money_template_TD.fsf

else

	MAINOUTPUT=${MAINDIR}/${SUBJ}_Model9_money_${SMOOTH}mm_ST
	TEMPLATE=reward_model_9_money_template.fsf
