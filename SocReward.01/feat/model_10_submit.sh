	...
	for NEG in "no"; do
		...
		#for SUBJ in 33754 33757; do
			...
			for RUN in 2 3 4 5 6; do
				...
				qsub -v EXPERIMENT=SocReward.01 reward_model_10_faces.sh ${SUBJ} ${RUN} ${NEG} ${SCALEDONLY} ${GO}
				qsub -v EXPERIMENT=SocReward.01 reward_model_10_money.sh ${SUBJ} ${RUN} ${NEG} ${SCALEDONLY} ${GO}
