...
if [ "$TD" == "yes" ]; then
	...
	MAINOUTPUT=${MAINDIR}/${SUBJ}_Model9_faces_NoMotor_${SMOOTH}mm_ST_TD
	TEMPLATE=reward_model_9_faces_template_NoMotor_TD.fsf

else

	MAINOUTPUT=${MAINDIR}/${SUBJ}_Model9_faces_NoMotor_${SMOOTH}mm_ST
	TEMPLATE=reward_model_9_faces_template_NoMotor.fsf
