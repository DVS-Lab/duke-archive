...
n_fake_jobs = 14               #during business hours, pretend there are extra jobs to try and leave a few spots open
...
#subnums = ["47481", "47489", "47502", "47524", "47545", "47546", "47553", "47556", "47557", "47559", "47583", "47586", "47591", "47601"]
#OPTIONS = ["PERM1", "PERM2", "PERM3", "PERM4", "OPTION_0.5", "OPTION_1", "OPTION_0.25", "OPTION_1.5", "OPTION_2", "OPTION_5", "OPTION_10", "OPTION_20"]
OPTIONS = ["1", "2", "3", "4"]
COPES = ["1", "2"]
TYPES = ["2", "3", "0", "1"]
AR1S = ["0", "1"]
		...
		for TYPE in TYPES:
			...
			for COPE in COPES:
				...
				for OPTION in OPTIONS:
					...
					tmp_job_file = tmp_job_file.replace( "SUB_TYPE_VAR", str(TYPE) )
					...
					tmp_job_fname = "_".join( ["L3", COPE, OPTION, TYPE, AR1] )
