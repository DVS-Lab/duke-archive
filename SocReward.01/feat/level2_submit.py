...
template_f = file("level2_linear.sh")  #job template location (on head node)
...
min_jobs = 7                 #minimum number of jobs to keep in q even when crowded
...
for GO in GOES:
	...
	for CONDITION in CONDITIONS:
		...
		for subnum in subnums:
			...
			tmp_job_fname = "_".join( ["L2", subnum, CONDITION, GO] )
