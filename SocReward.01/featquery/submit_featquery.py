...
template_f = file("featquery_short_paired.sh")  #job template location (on head node)
...
#OPTIONS = ["PERM1", "PERM2", "PERM3", "OPTION_0.5", "OPTION_1", "OPTION_0.25", "OPTION_1.5", "OPTION_2"]
models = ["4star-1star_MINUS_5+2gain-5+2loss", "4star-1star_MINUS_5gain-5loss", "4star-1star_MINUS_gain-loss", "hot-not_MINUS_5+2gain-5+2loss", "hot-not_MINUS_5gain-5loss", "hot-not_MINUS_gain-loss"]
#copes = ["1", "2"]
...
for subnum in subnums:
	...
	for model in models:
		...
		#tmp_job_file = tmp_job_file.replace( "SUB_COPE_VAR", str(cope) )

		#make fname and write job file to cwd
		tmp_job_fname = "_".join( ["FQ", model, subnum] )
