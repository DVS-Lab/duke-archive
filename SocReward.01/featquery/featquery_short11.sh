...
echo $MODELDIR
	...
	for MASKNAME in "5+2gain-5+2loss_all.nii.gz" "4star-1star_all.nii.gz" "5+2gain-5+2loss_trimmed.hdr" "4star-1star_trimmed.hdr"; do
...
OUTDIR=$MAINDIR/Featquery_Logs_functional/${MODEL}
mkdir -p $OUTDIR
