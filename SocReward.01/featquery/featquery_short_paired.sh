...
#paired_mOFC_mask.nii.gz
MASKNAME=overlap_vmPFC
MASK=${MAINDIR}/ROIs_functional/overlap_vmPFC.nii.gz
featquery 1 ${COPE} 1  stats/cope3 ${MASKNAME}_featquery -p ${MASK}


OUTDIR=$MAINDIR/Featquery_Logs_June2009/${MODEL}_NEW_2
mkdir -p $OUTDIR
