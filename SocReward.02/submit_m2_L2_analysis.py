...
template_f = file("m2_L2_analysis.sh")  #job template location (on head node)
	...
	for fnirt in fnirts:
		for smooth in smooths:
			for subnum in subnums:
				...
				tmp_job_file = tmp_job_file.replace( "SUB_FNIRT_SUB", fnirt )
				...
				tmp_job_fname = "_".join( ["L1", subnum, fnirt, smooth, go] )
