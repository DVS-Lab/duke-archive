...
username = "jsy4"             #your cluster login name (use what shows up in qstatall)
useremail = "jsy4@biac.duke.edu"    #email to send job notices to
template_f = file("m2_L1_analysis.sh")  #job template location (on head node)
		...
		for smooth in smooths:
			for subnum in subnums:
				for run in runs:
					...
					tmp_job_fname = "_".join( ["L1", subnum, runstr, smooth, fnirt, go] )
