...
sleep_time = 60              #pause time (sec) between job count checks
		...
		for task in tasks:
			...
			for run in runs:
				for smooth in smooths:
					...
					tmp_job_fname = "_".join( ["UC", subnum, task, run, smooth, GO] )
					...
					#NO EDIT BELOW HERE, BUT DON'T FORGET INDENTATION
