...
for RUN in 1 4; do 
	...
	OUTPUT=${MAINDIR}/avu/SR02_reward_gPPI_DMN_ECN_allDRICs_cueseffects/PPI_${SUBJ}_run${RUN}
	...
	TEMPLATE=${MAINDIR}/avu/models/SR02_gPPI_allDRts_newzerooptions_cueseffects.fsf
	...
	-e 's@LFP@'$LFP'@g' \
	-e 's@RFP@'$RFP'@g' \
	<$TEMPLATE> ${SUBJDIR}/SR02_gPPI_allDRts_newzerooptions_cueseffects_edit.fsf
	
	feat ${SUBJDIR}/SR02_gPPI_allDRts_newzerooptions_cueseffects_edit.fsf
