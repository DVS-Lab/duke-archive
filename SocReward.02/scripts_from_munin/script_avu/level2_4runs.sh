...
TEMPLATE=${TEMPLATEDIR}/L2_4runs.fsf

INPUT1=${SUBJDIR}/PPI_${SUBJ}_run1.feat/stats/cope${COPE}.nii.gz
INPUT2=${SUBJDIR}/PPI_${SUBJ}_run2.feat/stats/cope${COPE}.nii.gz
INPUT3=${SUBJDIR}/PPI_${SUBJ}_run3.feat/stats/cope${COPE}.nii.gz
INPUT4=${SUBJDIR}/PPI_${SUBJ}_run4.feat/stats/cope${COPE}.nii.gz
...
-e 's@INPUT3@'$INPUT3'@g' \
-e 's@INPUT4@'$INPUT4'@g' \
<$TEMPLATE> ${MAINOUTPUT}/${SUBJ}_${COPE}_level2_4runs_edited.fsf

cd ${MAINOUTPUT}

feat ${SUBJ}_${COPE}_level2_4runs_edited.fsf
