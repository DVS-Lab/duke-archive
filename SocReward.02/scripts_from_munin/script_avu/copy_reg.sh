...
for RUN in 1 4; do 
	...
	MAINOUTPUT=${MAINDIR}/avu/SR02_social_anticip_gPPI_DMN_ECN_allDRICs/PPI_${SUBJ}_run${RUN}.feat
	
	cp -r ${MAINDIR}/FSL/${SUBJ}/MELODIC_FNIRT/Smooth_5mm/run${RUN}.ica/reg ${MAINOUTPUT}
