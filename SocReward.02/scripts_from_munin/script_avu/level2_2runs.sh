...
TEMPLATE=${TEMPLATEDIR}/L2_2runs.fsf

INPUT1=${SUBJDIR}/PPI_${SUBJ}_run1.feat/stats/cope${COPE}.nii.gz
INPUT2=${SUBJDIR}/PPI_${SUBJ}_run4.feat/stats/cope${COPE}.nii.gz
...
-e 's@INPUT1@'$INPUT1'@g' \
-e 's@INPUT2@'$INPUT2'@g' \
<$TEMPLATE> ${MAINOUTPUT}/${SUBJ}_${COPE}_level2_2runs_edited.fsf

cd ${MAINOUTPUT}

feat ${SUBJ}_${COPE}_level2_2runs_edited.fsf
