function compare_networks_face_scene_network_run5_jake_dvs(~)
    maindir = pwd;
    my_Nics = 25;
    ...
    mask = fullfile(maindir,'run5_FLIRT','gica_unconfounded_tensor_DR_25dim.ica','mask.nii.gz'); 
        ...
        title('DR')
        dlmwrite('face-scene_network_corr_unconfounded_tensor_run5_DR.csv',corr_mat,'delimiter',',','precision','%.6f')
end
