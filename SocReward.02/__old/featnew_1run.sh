...
FSLDATADIR2=${EXPERIMENT}/Analysis/Cluster/PassiveTask/${SUBJ}/${SUBJ}_ica_p01_noBET/${SUBJ}_run${run}.ica
...
MAINOUTPUT=${MAINDIR}/${SUBJ}_feat_noTD_test_noBET
TEMPLATEDIR=${EXPERIMENT}/Analysis/Cluster/PassiveTask/AnalysisTemplates
OUTPUTREAL=${MAINOUTPUT}/${SUBJ}_run${run}_noTD.feat
...
DATA=${FSLDATADIR2}/filtered_func_data.nii.gz
...
if [ -e $MOTOR ]
then
 for i in 'template_noTD_m_new.fsf'; do
