...
MAINDIR=$FSLDATADIR2/${SUBJ}_feat_noTD_test_noBET
MAINOUTPUT=${FSLDATADIR2}/${SUBJ}_lvl2_test_noBET
OUTPUT=${MAINOUTPUT}
FSLDATADIR=${MAINDIR}
...
INPUT1=${MAINDIR}/${SUBJ}_run2_noTD.feat
INPUT2=${MAINDIR}/${SUBJ}_run3_noTD.feat
INPUT3=${MAINDIR}/${SUBJ}_run4_noTD.feat
INPUT4=${MAINDIR}/${SUBJ}_run5_noTD.feat
INPUT5=${MAINDIR}/${SUBJ}_run6_noTD.feat



for i in $EXPERIMENT/Analysis/Cluster/PassiveTask/AnalysisScripts/Passive_scripts/higherlevel/'Model4_2ndLvl.fsf'; do
