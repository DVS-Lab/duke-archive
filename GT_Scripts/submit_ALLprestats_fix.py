...
template_f = file("ALLprestats_fix.sh")  #job template location (on head node)
...
max_run_hours = 20000	#maximum number of hours submission script can run
warning_time = 72         #send out a warning after this many hours informing you that the deamon is still running
...
#subnums = [ "1002", "1005", "1006", "1007", "1008", "1009", "1010", "1011", "1012", "1013", "1014", "1015", "1016", "1017", "1018", "1019", "1020", "1021", "1022", "1023", "1024", "1025", "1026", "1027", "1028", "1029", "1030", "1031", "1032", "1033", "1034", "1035", "1036", "1037", "1038", "1039" ]
#subnums = [ "1026", "1027", "1028", "1029", "1030", "1031", "1032", "1033", "1034", "1035", "1036", "1037", "1038", "1039" ]
subnums = [ "1024", "1025", ]
		...
		for fnirt in fnirts:
			for smooth in smooths:
				for subnum in subnums:
					for run in runs:
						#if run == 5 & (subnum == "1023" or subnum == "1020"):
						#	continue
						...
						tmp_job_fname = "_".join( ["ALLprestats", subnum, runstr, smooth, fnirt, go] )
						...
						while n_jobs >= maintain_n_jobs: 
							...
							if n_jobs >= maintain_n_jobs: 
								...
								#cmd = "qsub -q highram.q -v EXPERIMENT=%s %s"  % ( experiment, tmp_job_fname )
