...
template_f = file("m5_L1_analysis.sh")  #job template location (on head node)
...
subnums = [ "1020", "1023", "1002", "1005", "1006", "1007", "1008", "1009", "1010", "1011", "1012", "1013", "1014", "1015", "1016", "1017", "1018", "1019", "1021", "1022", "1024", "1025", "1026", "1027", "1028", "1029", "1030", "1031", "1032", "1033", "1034", "1035", "1036", "1037", "1038", "1039" ]
		...
		for fnirt in fnirts:
			for smooth in smooths:
				for subnum in subnums:
					for run in runs:
						if (int(subnum) == 1020 or int(subnum) == 1023) and int(run) == 5:
							continue
						...
						for trial in trials:
							...
							tmp_job_fname = "_".join( ["HiRes_trial", trialstr, subnum, runstr, go] )
							...
							while n_jobs >= maintain_n_jobs: 
								...
								if n_jobs >= maintain_n_jobs: 
									...
									cmd = "qsub -l h_vmem=24G -v EXPERIMENT=%s %s"  % ( experiment, tmp_job_fname )
