...
maintain_n_jobs = 8         #leave one in q to keep them moving through
...
delayt = 10		  #delay time between job submissions
				...
				for subnum in subnums:
					for run in runs:
						for trial in trials:
							...
							tmp_job_fname = "_".join( ["HiRes_trial", trialstr, subnum, run, go] )
							...
							while n_jobs >= maintain_n_jobs: 
								...
								if n_jobs >= maintain_n_jobs: 
									...
									cmd = "qsub -l h_vmem=32G -v EXPERIMENT=%s %s"  % ( experiment, tmp_job_fname )
