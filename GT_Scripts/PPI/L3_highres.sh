...
for LIST in "12 PHYS" "13 PPI+" "14 PPI-"; do
	...
	for SUBJ in 1002 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 1017 1018 1019 1020 1021 1022 1023; do
		if [ $FNIRT -eq 1 ]; then
			L2OUTPUT=${MAINDIR}/FSL/${SUBJ}/Model03_FNIRT_${ROI}ppi/Smooth_${SMOOTH}mm
			MAINOUTPUT=${MAINDIR}/FSL/Level3_n${NSUBJECTS}/Model03_FNIRT_${ROI}ppi/Smooth_${SMOOTH}mm
		else
			L2OUTPUT=${MAINDIR}/FSL/${SUBJ}/Model03_FLIRT_${ROI}ppi/Smooth_${SMOOTH}mm
			MAINOUTPUT=${MAINDIR}/FSL/Level3_n${NSUBJECTS}/Model03_FLIRT_${ROI}ppi/Smooth_${SMOOTH}mm
		fi
