...
# Lower-level contrast 3 (PHYS)
# Lower-level contrast 4 (PPI_pos)
# Lower-level contrast 5 (PPI_neg)

for LIST in "1 Face-Land" "2 Land-Face" "3 PHYS" "4 PPI_pos" "5 PPI_neg"; do
	set -- $LIST
	CNUM=$1
	CNAME=$2
	...
	for SUBJ in 1002 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 1017 1018 1019 1020 1021 1022 1023; do
		if [ $FNIRT -eq 1 ]; then
			L2OUTPUT=${MAINDIR}/FSL/${SUBJ}/Model04_FNIRT_PPI_${ROI}/Smooth_${SMOOTH}mm
			MAINOUTPUT=${MAINDIR}/FSL/Level3_n${NSUBJECTS}/Model04_FNIRT_PPI_${ROI}/Smooth_${SMOOTH}mm
		else
			L2OUTPUT=${MAINDIR}/FSL/${SUBJ}/Model04_FLIRT_PPI_${ROI}/Smooth_${SMOOTH}mm
			MAINOUTPUT=${MAINDIR}/FSL/Level3_n${NSUBJECTS}/Model04_FLIRT_PPI_${ROI}/Smooth_${SMOOTH}mm
		fi
	...
	rm -rf ${OUTPUT}.gfeat/var_filtered_func_data.nii.gz
