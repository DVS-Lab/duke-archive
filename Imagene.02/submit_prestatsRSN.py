...
template_f = file("prestatsRSN.sh")  #job template location (on head node)
...
max_run_time = 999999999           #maximum time any job is allowed to run in minutes
max_run_hours = 99999999	#maximum number of hours submission script can run
warning_time = 9999999         #send out a warning after this many hours informing you that the deamon is still running
