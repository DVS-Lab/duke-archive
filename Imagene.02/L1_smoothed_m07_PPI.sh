...
mkdir -p $MAINOUTPUT
OUTPUT=${MAINOUTPUT}/L1_run${R}_4mm_m07_dim04_FC_uni
rm -rf ${OUTPUT}.feat
...
NETEVDIR=${MAINOUTPUT}/L1_run${R}_4mm_m07_dim04_FC.feat
NET1=${NETEVDIR}/uni_ts_roi1.txt
NET2=${NETEVDIR}/uni_ts_roi2.txt
NET3=${NETEVDIR}/uni_ts_roi3.txt
NET4=${NETEVDIR}/uni_ts_roi4.txt


TEMPLATE=${MAINDIR}/StrParc/templates/L1_dim04_taskFC.fsf
...
-e 's@NET3@'$NET3'@g' \
-e 's@NET4@'$NET4'@g' \
<$TEMPLATE> ${MAINOUTPUT}/L1_run${R}_m07_FC.fsf
feat ${MAINOUTPUT}/L1_run${R}_m07_FC.fsf

rm -rf ${OUTPUT}.feat/filtered_func_data.nii.gz
rm -rf ${OUTPUT}.feat/stats/corrections.nii.gz
rm -rf ${OUTPUT}.feat/stats/res4d.nii.gz

OUTDIR=${MAINDIR}/Logs/MID_L1_m07_FC
mkdir -p $OUTDIR
