...
OUTPUT=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/NoLapses_RL/model${MODEL}

OUTDIR=$EXPERIMENT/Analysis/Framing/Logs/01Replication_RL/L2_m${MODEL}_go${GO}/$SUBJ
mkdir -p $OUTDIR
...
if [ $SUBJ -eq 10387 ] || [ $SUBJ -eq 10705 ] || [ $SUBJ -eq 10747 ] || [ $SUBJ -eq 10762 ] || [ $SUBJ -eq 11196 ] || [ $SUBJ -eq 11210 ] || [ $SUBJ -eq 11274 ] || [ $SUBJ -eq 11383 ] || [ $SUBJ -eq 12165 ] || [ $SUBJ -eq 12360 ] || [ $SUBJ -eq 12665 ] || [ $SUBJ -eq 12758 ] || [ $SUBJ -eq 12789 ]; then
	...
	TEMPLATE=$EXPERIMENT/Analysis/Framing/Templates/L2_20copes_2runs_RL.fsf
...
elif  [ $SUBJ -eq 10426 ] || [ $SUBJ -eq 10782 ] || [ $SUBJ -eq 11058 ] || [ $SUBJ -eq 11372 ] || [ $SUBJ -eq 11659 ] || [ $SUBJ -eq 11865 ] || [ $SUBJ -eq 11878 ] || [ $SUBJ -eq 12768 ] || [ $SUBJ -eq 12840 ]; then
	FEAT1=${OUTPUT}/run1.feat
	TEMPLATE=$EXPERIMENT/Analysis/Framing/Templates/L2_20copes_1run_RL.fsf
	sed -e 's@OUTPUT@'$OUTPUT'@g' \
	-e 's@FEAT1@'$FEAT1'@g' \
	<$TEMPLATE> ${OUTPUT}.fsf
	...
	TEMPLATE=$EXPERIMENT/Analysis/Framing/Templates/L2_20copes_3runs_RL.fsf
	sed -e 's@OUTPUT@'$OUTPUT'@g' \
	-e 's@FEAT1@'$FEAT1'@g' \
	-e 's@FEAT2@'$FEAT2'@g' \
	-e 's@FEAT3@'$FEAT3'@g' \
