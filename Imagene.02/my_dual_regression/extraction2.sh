...
for TASK in "Resting" "MID"; do
	...
	if [ -e ${DATA} ]; then
		...
		OUTFILE=${MAINDIR}/${SUBJ}/${TASK}/MELODIC_150/Smooth_${SMOOTH}mm/run${RUN}.ica/inverse_striatum_std_unconfounded_data_fnirt_2mm
		fslmaths $INFILE -mas inverse_striatum $OUTFILE
