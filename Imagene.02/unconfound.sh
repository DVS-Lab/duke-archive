...
MAINOUTPUT=${SUBJDIR}/${TASK}/MELODIC_FLIRT/Smooth_6mm
CONFOUNDDIR=${SUBJDIR}/${TASK}/MELODIC_FLIRT/Smooth_6mm
...
OUTLIERVOLS=${OUTPUTREAL}/bad_timepoints.txt
MOTION=${OUTPUTREAL}/MOTIONconfoundevs.txt
CONFOUNDEVSFILE=${OUTPUTREAL}/for_unconfound.txt
...
OUTDIR=$MAINDIR/Logs/unconfound3
mkdir -p $OUTDIR
