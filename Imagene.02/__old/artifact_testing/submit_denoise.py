...
template_f = file("denoise.sh")  #job template location (on head node)
...
for GO in GOES:
	...
	#for each run
		for smooth in smooths:
			...
			#tmp_job_file = tmp_job_file.replace("SUB_DENOISE_SUB",str(denoise_type) )


			#make fname and write job file to cwd
			tmp_job_fname = "_".join( ["ICAfilt", subnum, GO] )
