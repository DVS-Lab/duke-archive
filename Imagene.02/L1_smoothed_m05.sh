...
mkdir -p $MAINOUTPUT
OUTPUT=${MAINOUTPUT}/L1_run${R}_6mm_m05_flobs
rm -rf ${OUTPUT}.feat
...
TEMPLATE=${MAINDIR}/StrParc/templates/L1_m05_flobs.fsf
...
-e 's@ZMISS@'$ZMISS'@g' \
-e 's@ZHIT@'$ZHIT'@g' \
<$TEMPLATE> ${MAINOUTPUT}/L1_run${R}_m05f.fsf
feat ${MAINOUTPUT}/L1_run${R}_m05f.fsf

cd ${OUTPUT}.feat
unconfound ${DATA} ufiltered_func_data_m05_flobs design.mat
...
OUTDIR=${MAINDIR}/Logs/MID_L1_m05f
mkdir -p $OUTDIR
