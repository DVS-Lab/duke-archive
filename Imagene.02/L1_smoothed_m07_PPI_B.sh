...
mkdir -p $MAINOUTPUT
OUTPUT=${MAINOUTPUT}/L1_run${R}_4mm_m07_ppi_net03
rm -rf ${OUTPUT}.feat
...
NETA=${NETEVDIR}/net01_run${R}.txt
NETB=${NETEVDIR}/net02_run${R}.txt #switch
NETC=${NETEVDIR}/net04_run${R}.txt
PHYS=${NETEVDIR}/net03_run${R}.txt #switch


TEMPLATE=${MAINDIR}/StrParc/templates/L1_m07_ppi.fsf
...
-e 's@NETC@'$NETC'@g' \
-e 's@PHYS@'$PHYS'@g' \
<$TEMPLATE> ${MAINOUTPUT}/L1_run${R}_m07_ppi_B.fsf
feat ${MAINOUTPUT}/L1_run${R}_m07_ppi_B.fsf
...
OUTDIR=${MAINDIR}/Logs/MID_L1_m07_ppiB
mkdir -p $OUTDIR
