...
MAINDIR=/mnt/BIAC/munin3.dhe.duke.edu/Huettel/Imagene.02/Analysis/TaskData
...
DATADIR=${MAINDIR}/${SUBJ}/${TASK}/MELODIC_FLIRT/Smooth_6mm/run${RUN}.ica
...
if [ -e ${DATA} ]; then
	...
	if [ ! -e ${OUT2N} ]; then
		...
		OUTDIR=$MAINDIR/groupICA_AU/Logs/DVSnormalization3/redo
	else
		OUTDIR=$MAINDIR/groupICA_AU/Logs/DVSnormalization3/done
	fi
