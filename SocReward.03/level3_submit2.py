...
template_f = file("level3b.sh")  #job template location (on head node)
experiment = "SocReward.03"    #experiment name for qsub
nodes = 12                   #number of nodes on cluster
maintain_n_jobs = 13         #leave one in q to keep them moving through
