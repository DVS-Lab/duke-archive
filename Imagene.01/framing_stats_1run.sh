...
MAINOUTPUT=${SUBJDIR}/${SUBJ}_FEAT_Smooth_${SMOOTH}mm
...
DATA=${SUBJDIR}/PreStatsOnly/${SUBJ}_prestats_Smooth_${SMOOTH}mm/run${RUN}.feat/new_filtered_func_data.nii.gz
...
REGRESSOR=${MAINDIR}/JustinEV.txt
