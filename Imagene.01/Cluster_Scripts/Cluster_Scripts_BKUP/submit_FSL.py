...
template_f = file("framing_task.sh")  #job template location (on head node)
...
n_fake_jobs = 19               #during business hours, pretend there are extra jobs to try and leave a few spots open
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_fname = "_".join( ["FSLsub", subnum, runstr ] )
