...
username = "vinod"             #your cluster login name (use what shows up in qstatall)
useremail = "vinod@biac.duke.edu"    #email to send job notices to
template_f = file("framing_model2_sl.sh")  #job template location (on head node)
...
subnums = ["47734","47735","47748","47752","47885","47945","47977","48066","48090","48097","48100","48103","48123","48145","48152","48156","48158","48165","48176","48187","48193","48206","48232","48271","48281","48301","48309","48312","48326","48327","48330","48335","48337","48351"]
 #should be entered in quotes to be used as strings
runs = range(1,2)  #[ 1, 2, 3, 4, 5, 6, 7, 8 ] range cuts the last number off any single runs should still be in [ ]
####!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
###############################################
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_fname = "_".join( ["FSLsub", subnum ] )
