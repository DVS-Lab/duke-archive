...
template_f = file("L3_m5_n58.sh")  #job template location (on head node)
...
copes = range(1,18)
cnames = ["chargain", "charloss", "selfgain", "selfloss", "cue", "gain-loss", "loss-gain", "char-self", "self-char", "chargain-charloss", "charloss-chargain", "selfgain-selfloss", "selfloss-selfgain", "chargain-selfgain", "selfgain-chargain", "charloss-selfloss", "selfloss-charloss"]
...
for covariate in covariates:
	...
	for cope in copes:
		...
		tmp_job_fname = "_".join( ["L3_m5", cname, str(cope), covariate ] )
