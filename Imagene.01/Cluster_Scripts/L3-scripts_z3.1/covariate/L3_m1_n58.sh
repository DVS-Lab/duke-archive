...
preOUTPUT=${MAINDIR}/Level3/high_thresh/Model1d/${TEMPLATE}
mkdir -p $preOUTPUT
...
<${TEMPLATE}t.fsf> ${MAINDIR}/Level3/Model1d/${TEMPLATE}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/Model1d/${TEMPLATE}/L3_n58_${CNAME}.fsf
