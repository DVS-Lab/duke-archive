...
CNAME=SUB_CNAME_SUB
MODEL=SUB_MODEL_SUB
TEMPLATE=L3_n58_S-C_cov

MAINDIR=${EXPERIMENT}/Analysis/Framing/FSL
preOUTPUT=${MAINDIR}/Level3_new/high_thresh/Model${MODEL}/${TEMPLATE}
mkdir -p $preOUTPUT
...
<${TEMPLATE}t.fsf> ${MAINDIR}/Level3_new/high_thresh/Model${MODEL}/${TEMPLATE}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3_new/high_thresh/Model${MODEL}/${TEMPLATE}/L3_n58_${CNAME}.fsf
