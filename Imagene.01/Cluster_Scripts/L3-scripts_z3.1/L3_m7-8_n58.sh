...
preOUTPUT=${MAINDIR}/Level3_new/high_thresh/Model${MODEL}
mkdir -p $preOUTPUT
...
<L3_n58t.fsf> ${MAINDIR}/Level3_new/high_thresh/Model${MODEL}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3_new/high_thresh/Model${MODEL}/L3_n58_${CNAME}.fsf
