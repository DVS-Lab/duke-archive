...
preOUTPUT=${MAINDIR}/Level3/high_thresh/Model1d
...
<L3_n58t.fsf> ${MAINDIR}/Level3/Model1d/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/Model1d/L3_n58_${CNAME}.fsf
