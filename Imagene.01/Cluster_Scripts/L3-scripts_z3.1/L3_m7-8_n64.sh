...
preOUTPUT=${MAINDIR}/Level3_new_n64/high_thresh/Model${MODEL}
mkdir -p $preOUTPUT
...
<L3_n64t.fsf> ${MAINDIR}/Level3_new_n64/high_thresh/Model${MODEL}/L3_n64_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3_new_n64/high_thresh/Model${MODEL}/L3_n64_${CNAME}.fsf
