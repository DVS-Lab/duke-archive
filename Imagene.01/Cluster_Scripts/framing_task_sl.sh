...
OUTPUT=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/${SUBJ}_model1d_sl
FEAT1=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/run1/${SUBJ}_model1d_run1.feat
FEAT2=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/run2/${SUBJ}_model1d_run2.feat
FEAT3=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/run3/${SUBJ}_model1d_run3.feat
OUTDIR=$EXPERIMENT/Analysis/Framing/Logs/DVS/L2_m1
mkdir -p $OUTDIR
...
TEMPLATE=$EXPERIMENT/Analysis/Framing/Templates/template_model1_sl.fsf
