...
template_f = file("L3_ALL_n58.sh")  #job template location (on head node)
...
cnames = [ "char_gain", "char_loss", "self_gain", "self_loss", "cue", "endowment", "ev", "char-self", "self-char", "loss-gain", "gain-loss", "interaction_pos", "interaction_neg" ]

fsftemplates = [ "L3_n58_new", "L3_n58_cov_new" ]
