...
template_f = file("L2_framing_ALL_PPI.sh")  #job template location (on head node)
...
n_fake_jobs = 16               #during business hours, pretend there are extra jobs to try and leave a few spots open
...
subnums = [ "47734", "47735", "48232", "48312" ]
...
contrasts = ["char-self", "gain-loss", "interaction"] #"charpar-selfpar", "gainpar-losspar",  "interaction_par"
goes = [ "10" ]
###############################################
		...
		for roi in rois:
			for model in models:
				...
				for subnum in subnums:
					...
					tmp_job_fname = "_".join( ["ppi_L2_m", model, subnum, contrast, roi, go ] )
