...
preOUTPUT=${MAINDIR}/Level3_n58_FINAL_May2010/Model${MODEL}
mkdir -p $preOUTPUT

OUTDIR=${preOUTPUT}/logs
mkdir -p $OUTDIR
OUTPUT=${preOUTPUT}/ANOVA_2x2_n58

rm -rf $OUTPUT.gfeat

N=0
for COPE in 1 2 3 4; do 
...
NEWFILE=${preOUTPUT}/L3_n58_ANOVA #appending .fsf lower in the script
TEMPLATE=${EXPERIMENT}/Analysis/Framing/Templates/ANOVA_2x2_n58 #appending .fsf lower in the script
