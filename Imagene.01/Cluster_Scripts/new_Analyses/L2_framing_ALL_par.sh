...
OUTPUT=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/NoLapses_par_both/model${MODEL}

OUTDIR=$EXPERIMENT/Analysis/Framing/Logs/DVS/L2_m${MODEL}_new_par
mkdir -p $OUTDIR
...
if [ $SUBJ -eq 47731 ] || [ $SUBJ -eq 48349 ] || [ $SUBJ -eq 48281 ] || [ $SUBJ -eq 48271 ]; then
	...
	TEMPLATE=$EXPERIMENT/Analysis/Framing/Templates/L2_40copes_2runs.fsf
	...
	TEMPLATE=$EXPERIMENT/Analysis/Framing/Templates/L2_40copes_3runs.fsf
	sed -e 's@OUTPUT@'$OUTPUT'@g' \
	-e 's@FEAT1@'$FEAT1'@g' \
	-e 's@FEAT2@'$FEAT2'@g' \
	-e 's@FEAT3@'$FEAT3'@g' \
