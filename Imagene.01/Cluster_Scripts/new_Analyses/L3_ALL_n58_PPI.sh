...
preOUTPUT=${MAINDIR}/Level3_n58_FINAL_October2011/PPI/${TEMPLATE}/Model${MODEL}/${ROI}/${CON}
mkdir -p $preOUTPUT
...
if [ -e $OUTPUT.gfeat/cope1.feat/randomise_out_tfce_corrp_tstat1.nii.gz ]; then
	echo "found randomise output..."
else
	rm -rf ${OUTPUT}.gfeat
fi
...
for SUBJ in 47725 47729 47731 47734 47735 47737 47748 47752 47851 47863 47878 47885 47917 47921 47945 47977 48012 48061 48066 48090 48097 48100 48103 48112 48123 48129 48150 48152 48156 48158 48160 48165 48167 48176 48179 48184 48187 48193 48196 48197 48204 48206 48271 48281 48288 48297 48301 48309 48321 48327 48330 48335 48337 48339 48344 48349 48350 48351; do
	...
	let N=$N+1
	FILENAME=${MAINDIR}/${SUBJ}/corrected_NoLapses_PPI/model${MODEL}/${ROI}/${CON}.gfeat/cope${COPE}.feat/stats/cope1.nii.gz
...
if [ -e randomise_out_tfce_corrp_tstat1.nii.gz ]; then
	echo "found randomise output"
else
