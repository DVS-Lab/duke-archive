...
preOUTPUT=${MAINDIR}/Level3_n58_FINAL_May2010/${TEMPLATE}/Model${MODEL}_par_both
mkdir -p $preOUTPUT
...
# exclude framing 48145 48172 48189 48232 48312 48326
	...
	let N=$N+1
	FILENAME=${MAINDIR}/${SUBJ}/NoLapses_par_both/model${MODEL}.gfeat/cope${COPE}.feat/stats/cope1.nii.gz
