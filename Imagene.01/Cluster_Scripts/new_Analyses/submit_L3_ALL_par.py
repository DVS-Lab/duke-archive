...
template_f = file("L3_ALL_n58_par.sh")  #job template location (on head node)
...
cnames = [ "chargain", "charloss", "selfgain", "selfloss", "motor", "cue", "chargain-charloss", "charloss-chargain", "selfgain-selfloss", "selfloss-selfgain", "self-char", "char-self", "gain-loss", "loss-gain", "chargain-selfgain", "selfgain-chargain", "charloss-selfloss", "selfloss-charloss", "interaction+", "interaction-", "chargain", "charloss", "selfgain", "selfloss", "motor", "cue", "chargain-charloss", "charloss-chargain", "selfgain-selfloss", "selfloss-selfgain", "self-char", "char-self", "gain-loss", "loss-gain", "chargain-selfgain", "selfgain-chargain", "charloss-selfloss", "selfloss-charloss", "interaction+", "interaction-" ]

fsftemplates = [ "L3_n58_z3p1", "L3_n58", "L3_n58_cov_p001", "L3_n58_p001", "L3_n58_cov_z3p1", "L3_n58_cov"]
...
for fsftemplate in fsftemplates:
	for model in models:
		for cope in copes:
			...
			#tmp_job_file = tmp_job_file.replace( "SUB_TYPE_SUB", str(partype) )
