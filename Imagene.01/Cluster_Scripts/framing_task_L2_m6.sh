...
OUTPUT=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/${SUBJ}_model6
FEAT1=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/run1/${SUBJ}_model6_run1.feat
FEAT2=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/run2/${SUBJ}_model6_run2.feat
FEAT3=$EXPERIMENT/Analysis/Framing/FSL/${SUBJ}/run3/${SUBJ}_model6_run3.feat
OUTDIR=$EXPERIMENT/Analysis/Framing/Logs/DVS/L2_m6
mkdir -p $OUTDIR
...
TEMPLATE=$EXPERIMENT/Analysis/Framing/Templates/L2_m4.fsf
