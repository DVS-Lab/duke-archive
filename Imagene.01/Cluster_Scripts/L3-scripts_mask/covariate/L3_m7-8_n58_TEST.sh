...
COPE=15
CNAME=chargain-selfgain_REAL
MODEL=7
TEMPLATE=L3_n58_S-C_cov

MAINDIR=${EXPERIMENT}/Analysis/Framing/FSL
preOUTPUT=${MAINDIR}/Level3/uncorrected/Model${MODEL}/${TEMPLATE}
mkdir -p $preOUTPUT
...
<${TEMPLATE}t.fsf> ${MAINDIR}/Level3/Model${MODEL}/${TEMPLATE}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/Model${MODEL}/${TEMPLATE}/L3_n58_${CNAME}.fsf
