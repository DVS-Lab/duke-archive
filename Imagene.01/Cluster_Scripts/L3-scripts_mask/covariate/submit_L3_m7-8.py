...
template_f = file("L3_m7-8_n58.sh")  #job template location (on head node)
...
cnames = ["chargain", "charloss", "selfgain", "selfloss", "motor", "cue", "chargain-charloss", "charloss-chargain", "selfgain-selfloss", "selfloss-selfgain", "self-char", "char-self", "gain-loss", "loss-gain", "chargain-selfgain", "selfgain-chargain", "charloss-selfloss", "selfloss-charloss"]

#copes = ["16"]
#cnames = ["selfgain-chargain"]

models = ["7"]

covariates = ["L3_n58_S-C_cov"]
...
for covariate in covariates:
	for model in models:
		for cope in copes:
			...
			tmp_job_fname = "_".join( ["L3_m", model, cname, str(cope), covariate ] )
