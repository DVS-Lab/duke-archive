...
ZTHRESH=SUB_THRESH_SUB


MAINDIR=${EXPERIMENT}/Analysis/Framing/FSL
preOUTPUT=${MAINDIR}/Level3/high_thresh_testing/Model${MODEL}/${TEMPLATE}/thresh${ZTHRESH}
mkdir -p $preOUTPUT
...
<${TEMPLATE}t_TEST.fsf> ${MAINDIR}/Level3/high_thresh/Model${MODEL}/${TEMPLATE}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/high_thresh/Model${MODEL}/${TEMPLATE}/L3_n58_${CNAME}.fsf
