...
maintain_n_jobs = 18         #leave one in q to keep them moving through
...
runs = ["1", "2"]  #[ 1, 2, 3, 4, 5, 6, 7, 8 ] range cuts the last number off any single runs should still be in [ ]
####!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
###############################################
...
for go in runs:
	...
	for subnum in subnums:
		...
		tmp_job_fname = "_".join( ["L2_m2", subnum, go ] )
