...
preOUTPUT=${MAINDIR}/Level3_new/Model${MODEL}
mkdir -p $preOUTPUT
...
<L3_n58.fsf> ${MAINDIR}/Level3/Model${MODEL}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/Model${MODEL}/L3_n58_${CNAME}.fsf
