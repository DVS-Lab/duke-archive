...
preOUTPUT=${MAINDIR}/Level3_new_n64/Model${MODEL}_badTRs
mkdir -p $preOUTPUT
...
<L3_n64.fsf> ${MAINDIR}/Level3_new_n64/Model${MODEL}/L3_n64_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3_new_n64/Model${MODEL}/L3_n64_${CNAME}.fsf
