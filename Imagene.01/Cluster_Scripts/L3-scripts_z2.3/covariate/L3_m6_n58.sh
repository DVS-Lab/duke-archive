...
preOUTPUT=${MAINDIR}/Level3/Model6/${TEMPLATE}
mkdir -p $preOUTPUT
...
<${TEMPLATE}.fsf> ${MAINDIR}/Level3/Model6/${TEMPLATE}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/Model6/${TEMPLATE}/L3_n58_${CNAME}.fsf
