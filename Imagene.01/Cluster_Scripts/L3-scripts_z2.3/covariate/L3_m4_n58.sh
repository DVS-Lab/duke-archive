...
preOUTPUT=${MAINDIR}/Level3/Model4/${TEMPLATE}
mkdir -p $preOUTPUT
if [ $COPE -lt 16 ]; then
	exit
else
...
<${TEMPLATE}.fsf> ${MAINDIR}/Level3/Model4/${TEMPLATE}/L3_n58_${CNAME}.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/Model4/${TEMPLATE}/L3_n58_${CNAME}.fsf
