...
DATADIR=${EXPERIMENT}/Analysis/FSL/${SUBJ}/Passive/MELODIC2
for SMOOTH in 6 0; do
	for RUN in 1 2 3; do
		RUNDIR=${DATADIR}/Smooth_${SMOOTH}mm/run${RUN}.ica
		cd ${DATADIR}/Smooth_${SMOOTH}mm/crap
...
DATADIR=${EXPERIMENT}/Analysis/FSL/${SUBJ}/Active/MELODIC2
for SMOOTH in 6 0; do
	for RUN in 1 2; do
		RUNDIR=${DATADIR}/Smooth_${SMOOTH}mm/run${RUN}.ica
		cd ${DATADIR}/Smooth_${SMOOTH}mm/crap
...
DATADIR=${EXPERIMENT}/Analysis/FSL/${SUBJ}/PassiveCued/MELODIC2
for SMOOTH in 6 0; do
	for RUN in 1 2; do
		RUNDIR=${DATADIR}/Smooth_${SMOOTH}mm/run${RUN}.ica
		cd ${DATADIR}/Smooth_${SMOOTH}mm/crap
