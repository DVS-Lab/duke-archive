...
template_f = file("L3_m7_n51.sh")  #job template location (on head node)
...
copes = range(1,5)
cnames = ["global_pos", "global_neg", "local_pos", "local_neg"]
ROIs = ["PCC1", "PCC2", "PCC3"]
...
for ROI in ROIs:
	for cope in copes:
		...
		tmp_job_fname = "_".join( ["L3", ROI, cname, str(cope) ] )
