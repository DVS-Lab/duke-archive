...
preOUTPUT=${MAINDIR}/Level3/Model4
mkdir -p $preOUTPUT
OUTPUT=${preOUTPUT}/ANOVA_2x2_m4_n58
...
<ANOVA_2x2_n58.fsf> ${MAINDIR}/Level3/Model4/ANOVA_2x2.fsf

$FSLDIR/bin/feat ${MAINDIR}/Level3/Model4/ANOVA_2x2.fsf
