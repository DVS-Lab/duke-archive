...
OUTPUT=${MAINDIR}/Level3/Model3bycope/ANOVA_self_dvs

N=0
for COPE in 9 10 11 12; do 
...
<template_model3_2wayanova_dvs.fsf> ${MAINDIR}/Level3/Model3bycope/ANOVA_self.fsf

feat ${MAINDIR}/Level3/Model3bycope/ANOVA_self.fsf
