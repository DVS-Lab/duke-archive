...
template_f = file("02_L3_ALL_n217_randomise_thresh.sh")  #job template location (on head node)
...
#fsftemplates = [ "L3_n217_cov_lin_RL", "L3_n217_cov_linquad_RL" ]

fsftemplates = [ "L3_n217_cov_lin_RL_noLapses" ]
