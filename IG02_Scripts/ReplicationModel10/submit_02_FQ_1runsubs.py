...
template_f = file("02_FQ_1runsubs.sh")  #job template location (on head node)
...
#model 10 n217
subnums = [ 10426, 10782, 11058, 11372, 11659, 11865, 11878, 12768, 12840, 12176, 10360, 10474, 12314 ]
