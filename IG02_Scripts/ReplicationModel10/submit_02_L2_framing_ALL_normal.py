...
template_f = file("02_L2_framing_ALL_normal.sh")  #job template location (on head node)
...
#subs rerun b/c didn't take first time
subnums = ["10156"]
#allsubs (broken down into different groups below)
