...
template_f = file("MVPA_all_ROIs_perm.sh") 	#job template location (on head node)
...
min_jobs = 125                 		#minimum number of jobs to keep in q even when crowded
...
masks = [ "aVMPFC_5mm", "aVMPFC_pVMPFC", "mTG_5mm", "mTG_aVMPFC", "mTG_aVMPFC_pVMPFC", "mTG_pVMPFC", "PCC_5mm", "PCC_aVMPFC", "PCC_aVMPFC_pVMPFC", "PCC_mTG_aVMPFC", "PCC_mTG_aVMPFC_pVMPFC", "PCC_mTG", "PCC_mTG_pVMPFC", "PCC_pVMPFC", "pVMPFC_5mm", "TPJ_5mm", "TPJ_aVMPFC", "TPJ_aVMPFC_pVMPFC", "TPJ_mTG_aVMPFC", "TPJ_mTG_aVMPFC_pVMPFC", "TPJ_mTG", "TPJ_mTG_pVMPFC", "TPJ_PCC_aVMPFC", "TPJ_PCC_aVMPFC_pVMPFC", "TPJ_PCC_mTG_aVMPFC", "TPJ_PCC_mTG", "TPJ_PCC_mTG_pVMPFC", "TPJ_PCC", "TPJ_PCC_pVMPFC", "TPJ_pVMPFC" ]
	...
	for mask in masks:
		...
		while n_jobs >= maintain_n_jobs: 
			...
			if n_jobs >= maintain_n_jobs: 
				...
				cmd = "qsub -l h_rt=02:00:00 -l h_vmem=2G -v EXPERIMENT=%s %s"  % ( experiment, tmp_job_fname )
