...
<template_PYMVPA_ROI_combos_SMLR.py> ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_SMLR.py

python ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_SMLR.py
