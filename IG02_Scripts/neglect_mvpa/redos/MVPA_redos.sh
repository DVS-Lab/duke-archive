...
<template_PYMVPA_ROI_combos_redos.py> ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_${DATATYPE}_${CLASSIFIER}.py

python ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_${DATATYPE}_${CLASSIFIER}.py
...
OUTDIR=$MAINDIR/Logs/$MASK/$NCOMBO/l1
mkdir -p $OUTDIR
