...
<template_PYMVPA_ROI_combos_RBF.py> ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_RBF.py

python ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_RBF.py
