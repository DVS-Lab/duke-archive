...
maintain_n_jobs = 35        		#leave one in q to keep them moving through
...
comboN = int(combo)
fname = ("/home/%s/Imagene.02/neglect_mvpa/combo4_new_L1/combo_4_SMLR_lambda_1_new_missingROIs.txt") % (username)
