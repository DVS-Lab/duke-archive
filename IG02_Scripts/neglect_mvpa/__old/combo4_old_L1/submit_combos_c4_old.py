...
template_f = file("write_SMLR_jobs.sh") #job template location (on head node)
...
comboN = int(combo)
fname = ("/home/%s/Imagene.02/neglect_mvpa/combo4_old_L1/combo_4_SMLR_lambda_1_old_missingROIs.txt") % (username)
...
for mask in masks:	
	...
	for i in range(1,N_vars+1):
		...
		tmp_job_fname = "_".join( [combo_c, "SMLR", i_str, mask] )
