...
<template_PYMVPA_ROI_equal_weight3.py> ${MAINOUTPUT}/mvpa_combo4_${ROI}_${DATATYPE}_equal_${PERM}.py

python ${MAINOUTPUT}/mvpa_combo4_${ROI}_${DATATYPE}_equal_${PERM}.py
rm ${MAINOUTPUT}/mvpa_combo4_${ROI}_${DATATYPE}_equal_${PERM}.py
