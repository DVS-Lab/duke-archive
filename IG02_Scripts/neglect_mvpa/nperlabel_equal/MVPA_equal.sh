...
MAINOUTPUT=${MAINDIR}/PythonFiles/$MASK/$NCOMBO/${TESTNAME}
mkdir -p $MAINOUTPUT
...
<template_PYMVPA_ROI_equal_size.py> ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_${DATATYPE}_${CLASSIFIER}_equal.py

python ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_${DATATYPE}_${CLASSIFIER}_equal.py
rm ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${MASK}_${TESTNAME}_${DATATYPE}_${CLASSIFIER}_equal.py
