...
MAINOUTPUT=${MAINDIR}/PythonFiles/vox/redos
mkdir -p $MAINOUTPUT
...
<template_PYMVPA_vox_equal_redos.py> ${MAINOUTPUT}/mvpa_vox_${ID}_${CLASSIFIER}_equal_${REPEAT}.py

python ${MAINOUTPUT}/mvpa_vox_${ID}_${CLASSIFIER}_equal_${REPEAT}.py
