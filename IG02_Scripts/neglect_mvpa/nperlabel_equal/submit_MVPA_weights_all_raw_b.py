...
template_f = file("MVPA_equal_weights_all2.sh") 	#job template location (on head node)
experiment = "Imagene.02"   		#experiment name for qsub
nodes = 400                  		#number of nodes on cluster
maintain_n_jobs = 50        		#leave one in q to keep them moving through
...
#ROIs = [ '012_014', '012_016', '012_018', '012_030', '012_062', '012_064', '012_066', '012_082', '012_084', '012_086', '012_088', '014_016', '014_018', '014_030', '014_062', '014_064', '014_066', '014_082', '014_084', '014_086', '014_088', '016_018', '016_030', '016_062', '016_064', '016_066', '016_082', '016_084', '016_086', '016_088', '018_030', '018_062', '018_064', '018_066', '018_082', '018_084', '018_086', '018_088', '030_062', '030_064', '030_066', '030_082', '030_084', '030_086', '030_088', '062_064', '062_066', '062_082', '062_084', '062_086', '062_088', '064_066', '064_082', '064_084', '064_086', '064_088', '066_082', '066_084', '066_086', '066_088', '082_084', '082_086', '082_088', '084_086', '084_088', '086_088' ]

ROIs = [ '018_064', '018_066', '018_082', '018_084', '018_086', '018_088', '030_062', '030_064', '030_066', '030_082', '030_084', '030_086', '030_088', '062_064', '062_066', '062_082', '062_084', '062_086', '062_088', '064_066', '064_082', '064_084', '064_086', '064_088', '066_082', '066_084', '066_086', '066_088', '082_084', '082_086', '082_088', '084_086', '084_088', '086_088' ]
...
for ROI in ROIs:
	for datatype in datatypes:
		...
		fname = ("/home/smith/Imagene.02/neglect_mvpa/nperlabel_equal/missing_perms/missing_%s_%s.txt") % (ROI, datatype)
		if os.path.isfile(fname):
			...
			for perm in perms:
				...
				tmp_job_file = tmp_job_file.replace("SUB_PERM_SUB", newperm )
				
				#make fname and write job file to cwd
				tmp_job_fname = "_".join( ["get_weights", ROI, datatype, newperm ] )
				...
				while n_jobs >= maintain_n_jobs: 
					...
					if n_jobs >= maintain_n_jobs: 
						...
						cmd = "qsub -l h_vmem=5G,h_rt=00:20:00 -v EXPERIMENT=%s %s"  % ( experiment, tmp_job_fname )
