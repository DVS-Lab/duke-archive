...
MAINOUTPUT=${MAINDIR}/PythonFiles/ROIs/perm/$NCOMBO/${CLASSIFIER}
mkdir -p $MAINOUTPUT
...
<template_PYMVPA_ROI_equal_perm.py> ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${PERM}_${DATATYPE}_${CLASSIFIER}_equal.py

python ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${PERM}_${DATATYPE}_${CLASSIFIER}_equal.py
rm -rf ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${PERM}_${DATATYPE}_${CLASSIFIER}_equal.py
...
#OUTDIR=$MAINDIR/Logs/ROIs/perm/$NCOMBO/${CLASSIFIER}
#mkdir -p $OUTDIR
