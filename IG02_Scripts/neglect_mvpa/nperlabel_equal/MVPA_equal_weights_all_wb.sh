...
<template_PYMVPA_equal_weight_wb.py> ${MAINOUTPUT}/mvpa_wb_${DATATYPE}_equal_${PERM}.py

python ${MAINOUTPUT}/mvpa_wb_${DATATYPE}_equal_${PERM}.py
rm ${MAINOUTPUT}/mvpa_wb_${DATATYPE}_equal_${PERM}.py
