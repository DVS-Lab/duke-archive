...
template_f = file("MVPA_equal_weights_all3.sh") 	#job template location (on head node)
...
ROIs = [ '052_080_197', '064_066_082', '064_066_084', '064_082_084', '066_082_084' ]
...
for ROI in ROIs:
	for perm in perms:
		for datatype in datatypes:
			...
			tmp_job_fname = "_".join( ["sel_c4", "MVPA", ROI, datatype, perm_str] )
