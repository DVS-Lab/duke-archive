				...
				if os.path.isfile(fname):
					...
					for line in ROI_list:
						...
						for ROI in ROIs:
							...
							fname = ("/home/%s/Imagene.02/neglect_mvpa/nperlabel_equal/redos_ROIperms/missing_lists/combo%s/perm_roi_%s_combo%s_%s_CV_%sdata_%smissing.txt") % (username,combo,ROI_str,combo,classifier,datatype,rep)
