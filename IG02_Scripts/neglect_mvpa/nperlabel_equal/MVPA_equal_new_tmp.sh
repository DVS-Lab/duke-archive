...
<template_PYMVPA_ROI_equal_size.py> ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${TESTNAME}_${DATATYPE}_equal.py

python ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${TESTNAME}_${DATATYPE}_equal.py
rm ${MAINOUTPUT}/mvpa_combo${NCOMBO}_${ID}_${TESTNAME}_${DATATYPE}_equal.py
