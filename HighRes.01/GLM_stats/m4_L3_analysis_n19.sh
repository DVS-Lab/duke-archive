...
for LIST in "2 Face-Land" "3 Land-Face" "10 FaceH-FaceL" "11 LandH-LandL" "12 Land_U" "13 Face_U" "14 FaceM-FaceL" "15 LandM-LandL" "16 FaceH-FaceM" "17 LandH-LandM" "18 interaction" "19 high-low" "20 high-med" "21 med-low" "22 U_pos"; do
	...
	N=0
	for SUBJ in 1002 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 1017 1018 1019 1020 1022 1023; do
		if [ $FNIRT -eq 1 ]; then
			L2OUTPUT=${MAINDIR}/FSL/${SUBJ}/Model04_FNIRT_new/Smooth_${SMOOTH}mm
			MAINOUTPUT=${MAINDIR}/FSL/new_Level3_n${NSUBJECTS}/Model04_FNIRT_new/Smooth_${SMOOTH}mm
		else
			L2OUTPUT=${MAINDIR}/FSL/${SUBJ}/Model04_FLIRT/Smooth_${SMOOTH}mm
			MAINOUTPUT=${MAINDIR}/FSL/new_Level3_n${NSUBJECTS}/Model04_FLIRT_new/Smooth_${SMOOTH}mm
		fi
	...
	TEMPLATE=${MAINDIR}/FSL/templates/L3_template_n19_cov.fsf
