...
OUTPUTDIR=$TMPDIR/T1s_1.8mm_wholehead_ANTS
mkdir $OUTPUTDIR
...
for SUBJ in 1002 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 1017 1018 1019 1020 1021 1022 1023; do
	...
	STANDARD=${MAINOUTPUT}/run3.feat/reg/standard.nii.gz
	FLIRTIN=${EXPERIMENT}/Analysis/NIFTI/${SUBJ}/${SUBJ}_anat.nii.gz
	FLIRTOUT=${OUTPUTDIR}/${SUBJ}_T1_wholehead.nii.gz
	INMAT=${MAINOUTPUT}/run3.feat/reg/highres2standard.mat #from previous analysis
