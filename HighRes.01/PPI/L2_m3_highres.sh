...
if [ $FNIRT -eq 1 ]; then
	MAINOUTPUT=${MAINDIR}/FSL/${SUBJ}/Model03_FNIRT_${ROI}ppi/Smooth_${SMOOTH}mm
else
	MAINOUTPUT=${MAINDIR}/FSL/${SUBJ}/Model03_FLIRT_${ROI}ppi/Smooth_${SMOOTH}mm
fi
...
#L2_template_5runs_m3PPI.fsf
TEMPLATE=${MAINDIR}/FSL/templates/L2_template_${NRUNS}runs_m3PPI.fsf
